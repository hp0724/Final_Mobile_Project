...
public class ProcessOpenData {
    ...
    public String searchDataWithName(String stdate,String eddate,String rows,String cpage,String name){
        StringBuffer buffer=new StringBuffer();
    ...
    public String searchDataWithLocation( String stdate,String eddate,String rows,String cpage,String categorycode,String name,String location, String locationsub, String kidstate, String state){
        StringBuffer buffer=new StringBuffer();
        String queryUrl="http://www.kopis.or.kr/openApi/restful/pblprfr?service="+key+"&stdate="+stdate+"&eddate="+eddate+"&rows="+rows+"&cpage="+cpage;
                ...
                switch( eventType ){
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if(tag.equals("db")) ;// 첫번째 검색결과
                            ...
                            buffer.append("공연 시작일 :");
                            xpp.next();
                            buffer.append(xpp.getText());//address 요소의 TEXT 읽어와서 문자열버퍼에 추가
                            buffer.append("\n");//줄바꿈 문자 추가
                        }
                        else if(tag.equals("prfpdto")){
                            buffer.append("공연 종료일 :");
                            xpp.next();
                            buffer.append(xpp.getText());//mapx 요소의 TEXT 읽어와서 문자열버퍼에 추가
                            buffer.append("\n"); //줄바꿈 문자 추가
                        }
                            ...
                            buffer.append("공연 출연진 :");
                            xpp.next();
                            buffer.append(xpp.getText());//mapy 요소의 TEXT 읽어와서 문자열버퍼에 추가
                            buffer.append("\n"); //줄바꿈 문자 추가
                        }
                        else if(tag.equals("prfcrew")){
                            buffer.append("공연 제작진 :");
                            xpp.next();
                            buffer.append(xpp.getText());//mapy 요소의 TEXT 읽어와서 문자열버퍼에 추가
                            buffer.append("\n"); //줄바꿈 문자 추가
                        }
